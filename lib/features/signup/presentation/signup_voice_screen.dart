...
class _SignupVoiceScreenState extends State<SignupVoiceScreen> {
  ...
  void _onEnrollPressed() {
    ...
    feedback.announce('جاري بدء تسجيل الصوت', context);
        ...
        child: BlocListener<AuthCubit, AuthState>(
          listener: (context, state) {
            if (state is VoiceIdEnrollmentComplete) {
              ...
              feedback.announce('تم تسجيل الصوت بنجاح. جارٍ إكمال التسجيل...', context);
              ...
              feedback.playSuccessTone();
              feedback.announce('تم إنشاء الحساب بنجاح!', context);
              feedback.vibrateLight();
              print(
