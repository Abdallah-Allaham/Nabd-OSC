...
public class MainActivity extends FlutterFragmentActivity {
                ...
                .setMethodCallHandler((call, result) -> {
                    switch (call.method) {
                        ...
                        case "stopService":
                            ...
                            break;
                        // الدوال الجديدة للتحقق من الأذونات
                        ...
                        case "isAccessibilityEnabled":
                            ...
                            break;
                        // الدوال الجديدة لطلب الأذونات، مع إضافة منطق التوست
    ...
    private boolean isIgnoringBatteryOptimizations() {
        ...
        return true; // يعتبر مفعلًا على الإصدارات الأقدم
    }
    ...
    // إعادة صياغة دوال الطلب لتكون متوافقة مع الكود الجديد
    ...
    // New method to request accessibility permission
    private void requestAccessibilityPermission() {
        Intent intent = new Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS);
        startActivity(intent);
        // Display a message to the user explaining the next step
